...
This package provides some useful functions  for mixtures of Gaussian Markov random fields. The density function is given by $f(x|\Theta) = sum_{k=1}^{K}{\pi_k f_k(x|\mu_k,\Sigma_k)}$
