...
This package provides some useful functions for mixtures of Gaussian Markov random fields. The density function is given by *f*(*x*|*Θ*)=*s**u**m*<sub>*k* = 1</sub><sup>*K*</sup>*π*<sub>*k*</sub>*f*<sub>*k*</sub>(*x*|*μ*<sub>*k*</sub>, *Σ*<sub>*k*</sub>)
